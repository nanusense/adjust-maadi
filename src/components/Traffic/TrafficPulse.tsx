...
export function TrafficPulse() {
  ...
  return (
    <div className="rounded overflow-hidden shadow-lg" style={{ border: "1px solid rgba(45,80,22,0.1)", background: "#FEFCF8" }}>
      ...
      <div className="px-5 pt-4 pb-4">
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <h3 className="font-lora text-xl font-bold leading-tight" style={{ color: "#2D5016" }}>
              Road Traffic
            </h3>
          </div>
          <div className="text-right text-xs leading-relaxed mt-1" style={{ color: "#8B7355" }}>
            {isLive ? (
              <>
        ...
        <div
          ...
          style={{ background: "rgba(45,80,22,0.06)", border: "1px solid rgba(45,80,22,0.12)" }}
        >
          <span className="w-2 h-2 rounded-full flex-shrink-0 bg-green-600 animate-pulse" />
          <span className="text-xs" style={{ color: "#8B7355" }}>Current window:</span>
      ...
      {/* ── Corridor list — single column ── */}
      <div className="divide-y" style={{ borderTop: "1px solid rgba(45,80,22,0.08)", borderColor: "rgba(45,80,22,0.06)" }}>
            ...
            <div key={corridor.name}>
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  >
                    {liveData?.roadClosure ? "Closed" : cfg.label.charAt(0) + cfg.label.slice(1).toLowerCase()}
                  </span>
                </div>
              </button>
              ...
              {isSelected && (
                <div
                  ...
                  style={{ background: "rgba(45,80,22,0.025)" }}
                >
                  {liveData && (
                    <div
                      className="flex items-center gap-2 text-xs py-2 px-3 rounded mb-1"
      ...
      {/* Footer */}
      <div
        className="px-5 py-3 text-xs text-center border-t"
        style={{ color: "#8B7355", borderColor: "rgba(45,80,22,0.06)" }}
      >
        {isLive
